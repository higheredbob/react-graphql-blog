...
import { appoint, appointmentRows } from '../table/dataGenerator';

const items =  appointmentRows({
        appointment: {
          ...appoint,
...
class ThemeScheduler extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      data: appointments,
...
export default withStyles(styles, { name: 'EditingScheduler' })(ThemeScheduler);
